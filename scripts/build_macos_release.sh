...
cp -a SiliconNet.command siliconnet-launcher.sh run_tests.sh requirements.txt README.md README.tr.md README.de.md PRIVACY.md SECURITY.md SECURITY_HARDENING.md LICENSE NOTICE VERSION CHANGELOG.md RELEASE.md "$STAGE/"
